...
# %%
# Loading the dataset
encoded_train = np.load('Masked_NF_Python_Run_2//Encoded_All_RMT_No_NF_v2_Train.npy').reshape(629,16,16,16,1)   #Data
encoded_test  = np.load('Masked_NF_Python_Run_2//Encoded_All_RMT_No_NF_v2_Test.npy').reshape(70,16,16,16,1)   #Data
# encoded_train = np.load('2_Masked_Firing_Norm_Total_Python//Encoded_All_RMT_Firing_v2_Train.npy').reshape(629,16,16,16,1)   #Data
# encoded_test  = np.load('2_Masked_Firing_Norm_Total_Python//Encoded_All_RMT_Firing_v2_Test.npy').reshape(70,16,16,16,1)   #Data
Y_train       = np.load('Masked_NF_Python_Run_2//Y_All_RMT_Train.npy').reshape(629,15)
Y_test        = np.load('Masked_NF_Python_Run_2//Y_All_RMT_Test.npy').reshape(70,15)
...
# mapper.summary()
# with open('Model_Summary//ICASSP_Sims_Run_3//Summary_'+j+'_.txt', 'w') as f:
...
print('The cosine similarity of Both is: %.4f' %cosine_res)
print('The NMSE of SYN is: %.4f' %NMSE_syn)
print('The NMSE of Both is: %.4f' %NMSE_res)
