...
n_files          = 699
ds = 1
data_folder      = 'Masked_Normalized_All_RMT'
...
# Save Shuffled Data
np.save('Masked_No_NF_Python_Run_3//Y_All_RMT_Train', Y_train)
np.save('Masked_No_NF_Python_Run_3//Y_All_RMT_Test', Y_test)
np.save('Masked_No_NF_Python_Run_3//X_All_RMT_Train', X_train)
np.save('Masked_No_NF_Python_Run_3//X_All_RMT_Test', X_test)
...
# X & Y Data
X_train = np.load('Python_Data//X_All_RMT_Train.npy').reshape(629, 64, 64, 64, 1)
Y_train = np.load('Python_Data//Y_All_RMT_Train.npy').reshape(629, 15)
X_test  = np.load('Python_Data//X_All_RMT_Test.npy').reshape(70, 64, 64, 64, 1)
...
# with open('Model_Summary//ICASSP_Sims//Summary_AE_16_Cube_No_NF_run_2.txt', 'w') as f:
...
encoder.save('Masked_No_NF_Python_Run_3//Encoder_No_NF_run_3.h5')
...
np.save('Masked_No_NF_Python_Run_3//Encoded_All_RMT_No_NF_v3_Train', encoded_train)
np.save('Masked_No_NF_Python_Run_3//Encoded_All_RMT_No_NF_v3_Test', encoded_test)
